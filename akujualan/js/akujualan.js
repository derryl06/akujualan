                ...
                card.innerHTML = `
                    ...
                    <div style="padding: 24px; display: flex; flex-direction: column; gap: 12px;">
                        ...
                        <div style="display: flex; gap: 12px; margin-top: 8px;">
                            <a href="https://wa.me/6285700804186?text=Halo akujualan.co_! 👋%0A%0ASaya tertarik dengan paket bundling:%0A🎁 *${item.title}*%0A💰 Harga: ${displayPrice || 'Tanya Harga'}%0A%0AApakah paket ini masih tersedia? Terima kasih! ✨" class="btn btn-outline" style="flex: 1; text-align: center; text-decoration: none;" onclick="event.stopPropagation()">Pesan Paket</a>
                        </div>
                    </div>
                `;
